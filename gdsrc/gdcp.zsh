...
DEFAULT="$HOME/backup/Google-Drive"
...
# ✅ Confirm action
gum confirm "Ready to copy from 'gdrive:/' to '$dir' using flag '$flag'? Proceed?" || {
  echo "👋 Copy cancelled."
  exit 0
}
...
# 🚀 Start copy
gum spin --title "🚀 Copying from Google Drive..." -- rclone copy gdrive:/ "$dir" $flag
