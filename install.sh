...
for file in gdcp.zsh gdmnt.zsh gdup.zsh; do
  chmod +x "$TARGET/$PLUGIN_NAME/gdsrc/$file"
done

for file in odcp.zsh odmnt.zsh odup.zsh; do
  chmod +x "$TARGET/$PLUGIN_NAME/onesrc/$file"
done
...
REQUIRED_SOFTWARE=("gum" "noto-fonts-emoji")
